...
const osThreadAttr_t LoRa_Task_attributes = { .name = "LoRa_Task", .cb_mem = &LoRa_TaskControlBlock, .cb_size = sizeof(LoRa_TaskControlBlock), .stack_mem = &LoRa_TaskBuffer[0], .stack_size = sizeof(LoRa_TaskBuffer), .priority = (osPriority_t) osPriorityLow, };
...
static void MX_GPIO_Init(void) {
	...
	/*Configure GPIO pin Output Level */
	HAL_GPIO_WritePin(GPIOD, SPI2_NSS1_Pin | SPI2_NSS2_Pin | SPI2_NSS3_Pin | SPI2_NSS4_Pin | SPI2_NSS5_Pin, GPIO_PIN_RESET);
